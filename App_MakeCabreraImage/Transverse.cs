...
{
    public partial class Transverse : Form
    {
        ...
        public void make_Transverse()
        {
            ...
            //出力画像末尾に不可する文字列を取得
            sAddFileName = inifile.getIniDataString("SETTINGS", "transverse_name");
            ...
            iPaste_h = inifile.getIniDataInt("T_IMGPASTE", "h");
            iPaste_w = inifile.getIniDataInt("T_IMGPASTE", "w");
            ...
            try
            {
                ...
                foreach (string sJpgFile in saJpglist)
                {
                    ...
                    for (int i = 1; i <= 6; ++i)
                    {
                        ...
                        c_img_x = inifile.getIniDataInt("T_IMGCUT", "x" + i);
                        c_img_y = inifile.getIniDataInt("T_IMGCUT", "y" + i);
                        c_img_w = inifile.getIniDataInt("T_IMGCUT", "w" + i);
                        c_img_h = inifile.getIniDataInt("T_IMGCUT", "h" + i);

                        //貼り付け先配置座標x,y、切り取りの幅、高さのw,hをiniファイルより取得
                        p_img_x = inifile.getIniDataInt("T_IMGPASTE", "x" + i);
                        p_img_y = inifile.getIniDataInt("T_IMGPASTE", "y" + i);
                        p_img_to_x = inifile.getIniDataInt("T_IMGPASTE", "to_x" + i);
                        p_img_to_y = inifile.getIniDataInt("T_IMGPASTE", "to_y" + i);
                    ...
                    File.Copy(@"ECG.ini", sCompleteFolder + "\\ECG.ini", true);
